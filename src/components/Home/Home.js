...
const Home = () => {
  ...
  const categoriesForHer = [
    ...
    { name: "Sweatshirts", code: "SweatShirt", images: [{ url: 'https://cdn.shopify.com/s/files/1/0076/6040/4818/products/0-modelinfo-tamika-us2_eb86e6ac-da08-48eb-a415-c27396c051a1_450x610_crop_center.jpg?v=1674516904' }], gender: 'F' },
  ...
  const categoriesForHim = [{
    name: "Sweatshirts", code: "SweatShirt", images: [{ url: 'https://divinebonds.in/wp-content/uploads/2022/09/oversized-hoodie-mockup-of-a-serious-couple-sitting-in-cubes-at-a-studio-m26223.jpg' }], gender: 'M'},
    { name: "Shirts", code: "Shirt", images: [{ url: 'https://cdn.shopify.com/s/files/1/0420/7073/7058/products/Amin4179_1800x1800.jpg?v=1672146549' }], gender: 'M' },
    ...
    { name: "Pants", code: "Pant", images: [{ url: 'https://cdn.shopify.com/s/files/1/0752/6435/products/Layer8_6bb8e88c-6836-42bc-af3b-994b9a733be7_1452x1799.jpg?v=1661151328' }], gender: 'M' },
  ];
    return (
      <Fragment>
        {loading ?
